-- Fix Dividends Sections - Works with exact section ID

-- Step 1: Rename the existing section to add "(Spreadsheet)"
UPDATE sections
SET title = '1. Annual nominal dividends per share (Spreadsheet)'
WHERE id = '19dd39ad-a25b-4f53-acf4-5c31d44a914c';

-- Step 2: Create Python version with the same exercise
...
-- Step 3: Verify both sections now exist
SELECT
  id,
  title,
  supports_spreadsheet,
